...
namespace TTCore.StoreProvider.Extentions
{
    ...
    {
        public static void Test_POSTStreamPipe_MapEndpointRoute(this IEndpointRouteBuilder endpoints)
        {
        ...
        static async Task<List<string>> GetListOfStringsFromStream(Stream requestBody)
        {
        ...
        static async Task<List<string>> GetListOfStringsFromStreamMoreEfficient(Stream requestBody)
        {
            StringBuilder builder = new StringBuilder();
            byte[] buffer = ArrayPool<byte>.Shared.Rent(4096);
        ...
        static async Task<List<string>> GetListOfStringFromPipe(PipeReader reader)
        {
            List<string> results = new List<string>();
